...
Tipp: Die Paramter der Knoten auf dem Bogen lassen sich mit einem [kleinen Julia-Programm](musterloesung/tiergartenbruecke/parameter/parameters.jl) bestimmen. Hier die Werte:

```
Bogen
25.71%, 31.36%, 36.42%, 41.12%, 45.61%, 50.0%, 54.39%, 58.88%, 63.58%, 68.64%, 74.29%

Steg
20.41%, 26.32%, 32.24%, 38.16%, 44.08%, 50.0%, 55.92%, 61.84%, 67.76%, 73.68%, 79.59% 
```
