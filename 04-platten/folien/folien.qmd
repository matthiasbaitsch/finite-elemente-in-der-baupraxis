...
::: {.column width="65%"}
- Eine Faser, die im unverformten Zustand senkrecht auf der Mittelfläche steht, bleibt gerade

- Die senkrechte Verschiebung ist unabhängig von $z$

- Die Mittelfläche verschiebt sich nur in vertikaler Richtung

- Rotation der senkrechten Faser wird durch Winkelfunktionen $\alpha, \beta : \Omega \to \R$ beschrieben
...
- Deckenplatte 8 auf 8 Meter, 20cm dick, q = 


## Grundidee 1: Vorgegebene Funktionen zu Näherungslösung kombinieren
